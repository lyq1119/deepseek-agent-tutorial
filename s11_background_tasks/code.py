...
from deepseek_compat import DeepSeekClient
...
def _run_bash_process(command: str) -> tuple[str, Optional[int]]:
    process = None
    try:
...
def _format_bash_result(output: str, exit_code: Optional[int]) -> str:
